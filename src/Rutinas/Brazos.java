...
public class Brazos extends Rutina{
	...
	protected void buildEjercicios(){
		...
		try{
			try {
				a=new JSONArray(new FileReader("src/res/json/Brazos.json"));
		...
		for(int i=0;i<11;i++) {
			...
			e.setImagenGrandota(new ImageIcon(Contenido.class.getResource("/res/Imagenes_Ejercicios/Brazos/Brazos"+(i+1)+".png")));
			e.setImagenChikita(new ImageIcon(Contenido.class.getResource("/res/Imagenes_Ejercicios_Mini/Brazos/Brazos"+(i+1)+".png")));
